...
final class IncrementalBackupStrategyTest extends AbstractIntegrationTestCase
{
    ...
    {
        // 获取真实的服务实例
        $this->strategy = self::getService(IncrementalBackupStrategy::class);
